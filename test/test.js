...
describe('Tron Wallet', function () {
  ...
  it('Can unfreeze BANDWIDTH', async () => {
    assert.strictEqual(
    ...
    assert.strictEqual(
      TronWallet.fromTronPrivateKey(pk).unfreeze(refBlock, 'BANDWIDTH').hex,
      ''
    )
  })

  it('Can unfreeze ENERGY', async () => {
    assert.strictEqual(
      TronWallet.fromTronPrivateKey(pk).unfreeze(refBlock, 'ENERGY').hex,
      ''
    )
  })
